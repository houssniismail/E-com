    ...
    return (
        <div>
            ...
            <div className="bg-gray-50 h-[100vh] text-black/50 dark:bg-black dark:text-white/50">
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-3 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link href={route(`${auth.user.role}.dashboard`)} className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <>
                ...
                <form className="max-w-sm mx-auto" action="/category/store" method="POST" encType="multipart/form-data" >
                    ...
                    <div className="mb-5">
                        <label htmlFor="category_image" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category Image</label>
                        <input type="file" id="category_image" name='image' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required accept="image/*" />
                    </div>
